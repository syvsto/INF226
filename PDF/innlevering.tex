...
\subsection{HPE Fortify}
  ...
  It contains such tools as WebInspect, a dynamic code analsis tool, and the
  Fortify Static Code Analysis tool.

  Fortify is a propietary solution, but is available for free with an academic license.
 

\paragraph{Audit Workbench}

  Audit Workbench is the tool used to organize the the output of HPE's static
  code analysis software contained in the Fortify package. It is a GUI
  application built on top of Eclipse, specially designed for organizing and
