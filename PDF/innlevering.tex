...
summering av programmer og opplevelsen av å bruke default

Vi kom fram til diverse sikkerhetshull gjennom statisk og dynamisk kodeanalyse

Stort spenn i type feil fra implementasjon (design av) brukere og roller til
concurrency.

Statisk kodeanalyse virker helt essensiell for å finne concurrency feil i java.

Designfeil må alltid forståes gjennom manuell kodeanalyse. antakelig behov for
mer.
