...
\paragraph{FindBugs}
  ...
  \begin{itemize}
    ...
    \item Bad practice
      \item Bad use of return value from method
      \item Checking String equality using == or !=
      \item Confusing method name
      \item Database resource not closed on all paths
      \item Droppet or ignored excepton
      \item Dubious method invocation
      \item Format string problem
      \item Incorrect definition of Serializable class
      \item Initialization circularity
      \item Method ignores results of InputStream.read()
      \item Questionable use of reference equality rather than calling equals()
      \item Serializable class with no Version ID
      \item Stream not closed on all paths
      \item Unsafe inheritance
    \item Experimental
      \item Unsatified obligation to clean up stream or resource
    \item Internationalization 
      \item Dubious method used
    \item Malicious code vulnerability
      \item Method returning array may expose internal representation
      \item Mutable static field
      \item Storing reference to mutable object
      \item Use doPrivilieged
    \item Multithreaded code vulnerability
      \item Inconsistent synchronization
      \item Sleep with lock held
      \item Static use of type Calendar or DateFormat
      \item Unintended contention or possible deadlock due tp locking on shared objects
      \item Unsynchronized Lazy Initialization
    \item Performance
      \item Dubious method used
      \item Inefficient Map Iterator
      \item Inner class could be made static 
      \item Private method is never called
      \item Questionable Boxing of primitive value
      \item String concatination in loop using + operator
      \item Unread field
      \item Unread field should be static
      \item Unused field
    \item Security
    ...
    \item Dodgy code
      \item Bad casts of object references
      \item Bad use of return value from method
      \item Casting from integer values
      \item Confused Inheritance
      \item Dead local store
      \item Dubious method invocation
      \item Misuse of static fields
      \item Null pointer dereference
      \item Prefer zero length arrays to null to indicate no results
      \item Redundant Interfaces
      \item Redundant comparison to null
      \item RuntimeExceprion capture
      \item Test for floating point equality
      \item Unread field
      \item Unused field
      \item Unwritten field
      \item Useless code
      \item Useless control flow
